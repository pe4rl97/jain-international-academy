...
import { computerPhoto1, computerPhoto2, computerPhoto3, computerPhoto4 } from "../../assets/facilities/computer-lab"
        ...
        <Container className="facility-paragraph main-content">
            ...
            <div className="my-4 mb-5">
                ...
                <p data-aos='fade-in' data-aos-delay='400'>
                    Our school’s Computer Lab is designed to offer students hands-on experience with the latest technology. It houses 40 advanced computers, all connected through a dedicated LAN network, ensuring seamless accessibility and efficient learning. We take pride in maintaining a 1:1 student-to-computer ratio, allowing personalized interaction with technology.
                </p>
                <p data-aos='fade-in'>
            ...
            <Container className="photos">
                ...
                <Col xs='6' md='6' lg='4' data-aos='fade-up'>
                    ...
                    <Col xs='6' md='6' lg='6' data-aos='fade-up' data-aos-delay='100'>
                        <a href={computerPhoto4} className='d-block photo-item' data-fancybox='gallery'>
                            <img src={computerPhoto4} alt='Image' className='img-fluid'/>
                            <div className='photo-text-more'>
                                <div className='photo-text-more'>
                                    <h3 className='heading'><IoSearch /></h3>
                                </div>
