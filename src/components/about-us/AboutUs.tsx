    ...
    return (
        <section className="about-us-wrapper">
            <Container className='mt-5'>
                <h1 className="text-center about-us-title mb-5" data-aos='fade-in' id="about-us">About Us</h1>
                <Row className="g-0 justify-content-around mt-3 align-items-center">
                    <Col md='4' xs='11' className="column" data-aos='fade-right'>
                ...
                <Row className="mt-5 justify-content-around g-5 align-items-center">
                    <Col xs='11' className="h-50 d-md-none d-xs-block column"  data-aos='fade-left' data-aos-delay='100' >
                    ...
                    <Col md='4' className="h-50 d-none d-md-block column" data-aos='fade-left' data-aos-delay='100' >
                        <img src={sidePhoto2} alt="student teacher with blackboard" className="img-fluid rounded-3"/>
                    </Col>
                </Row>
            </Container>
