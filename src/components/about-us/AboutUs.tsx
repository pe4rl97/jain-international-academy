...
const AboutUs = () => {
    ...
    return (
        <section id="about-us" className="about-us-wrapper">
            <Container ref={statsRef} className={`mt-5 ${inView ? "in-view" : ""}`}>
                <h1 className="text-center about-us-title mb-5">About Us</h1>
                <Row className="g-0 justify-content-around mt-3 align-items-center">
                    <Col md='4' xs='11' className="column">
                        <img src={sidePhoto1} alt="student teacher with blackboard" className="img-fluid rounded-3"/>
                    </Col>
                    <Col md='6' xs='12' className="column mt-5">
                        <p className="text-p">
                ...
                <Row className="mt-5 justify-content-around g-5 align-items-center">
                    ...
                    <Col md='4' className="h-50 d-none d-md-block column">
                        <img src={sidePhoto2} alt="student teacher with blackboard" className="img-fluid rounded-3"/>
                    </Col>
                </Row>
            </Container>
